...
compute_split_frequencies <- function(forest_object, max_depth) {
    .Call('_grf_compute_split_frequencies', PACKAGE = 'tsgrf', forest_object, max_depth)
}

compute_weights <- function(forest_object, train_matrix, test_matrix, num_threads) {
    .Call('_grf_compute_weights', PACKAGE = 'tsgrf', forest_object, train_matrix, test_matrix, num_threads)
}

compute_weights_oob <- function(forest_object, train_matrix, num_threads) {
    .Call('_grf_compute_weights_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, num_threads)
}

merge <- function(forest_objects) {
    .Call('_grf_merge', PACKAGE = 'tsgrf', forest_objects)
}
...
causal_train <- function(train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_causal_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}
...
causal_predict <- function(forest_object, train_matrix, outcome_index, treatment_index, test_matrix, num_threads, estimate_variance) {
    .Call('_grf_causal_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, test_matrix, num_threads, estimate_variance)
}

causal_predict_oob <- function(forest_object, train_matrix, outcome_index, treatment_index, num_threads, estimate_variance) {
    .Call('_grf_causal_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, num_threads, estimate_variance)
}
...
ll_causal_predict <- function(forest_object, train_matrix, outcome_index, treatment_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance) {
    .Call('_grf_ll_causal_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
}
...
ll_causal_predict_oob <- function(forest_object, train_matrix, outcome_index, treatment_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance) {
    .Call('_grf_ll_causal_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
}
...
causal_survival_train <- function(train_matrix, causal_survival_numerator_index, causal_survival_denominator_index, treatment_index, censor_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_causal_survival_train', PACKAGE = 'tsgrf', train_matrix, causal_survival_numerator_index, causal_survival_denominator_index, treatment_index, censor_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}

causal_survival_predict <- function(forest_object, train_matrix, test_matrix, num_threads, estimate_variance) {
    .Call('_grf_causal_survival_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, test_matrix, num_threads, estimate_variance)
}

causal_survival_predict_oob <- function(forest_object, train_matrix, num_threads, estimate_variance) {
    .Call('_grf_causal_survival_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, num_threads, estimate_variance)
}
...
instrumental_train <- function(train_matrix, outcome_index, treatment_index, instrument_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_instrumental_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, treatment_index, instrument_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}
...
instrumental_predict <- function(forest_object, train_matrix, outcome_index, treatment_index, instrument_index, test_matrix, num_threads, estimate_variance) {
    .Call('_grf_instrumental_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, instrument_index, test_matrix, num_threads, estimate_variance)
}
...
instrumental_predict_oob <- function(forest_object, train_matrix, outcome_index, treatment_index, instrument_index, num_threads, estimate_variance) {
    .Call('_grf_instrumental_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, treatment_index, instrument_index, num_threads, estimate_variance)
}
...
multi_causal_train <- function(train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, gradient_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_multi_causal_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, gradient_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}
...
multi_causal_predict <- function(forest_object, train_matrix, test_matrix, num_outcomes, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, test_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
}

multi_causal_predict_oob <- function(forest_object, train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
}
...
multi_regression_train <- function(train_matrix, outcome_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_multi_regression_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}

multi_regression_predict <- function(forest_object, train_matrix, test_matrix, num_outcomes, num_threads) {
    .Call('_grf_multi_regression_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, test_matrix, num_outcomes, num_threads)
}

multi_regression_predict_oob <- function(forest_object, train_matrix, num_outcomes, num_threads) {
    .Call('_grf_multi_regression_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, num_outcomes, num_threads)
}
...
probability_train <- function(train_matrix, outcome_index, sample_weight_index, use_sample_weights, num_classes, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed) {
    .Call('_grf_probability_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, sample_weight_index, use_sample_weights, num_classes, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
}
...
probability_predict <- function(forest_object, train_matrix, outcome_index, num_classes, test_matrix, num_threads, estimate_variance) {
    .Call('_grf_probability_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, num_classes, test_matrix, num_threads, estimate_variance)
}

probability_predict_oob <- function(forest_object, train_matrix, outcome_index, num_classes, num_threads, estimate_variance) {
    .Call('_grf_probability_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, num_classes, num_threads, estimate_variance)
}
...
quantile_train <- function(quantiles, regression_splitting, train_matrix, outcome_index, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, nonlapping_block_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed, honesty_method) {
    .Call('_grf_quantile_train', PACKAGE = 'tsgrf', quantiles, regression_splitting, train_matrix, outcome_index, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, nonlapping_block_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed, honesty_method)
}

quantile_predict <- function(forest_object, quantiles, train_matrix, outcome_index, test_matrix, num_threads) {
    .Call('_grf_quantile_predict', PACKAGE = 'tsgrf', forest_object, quantiles, train_matrix, outcome_index, test_matrix, num_threads)
}

quantile_predict_oob <- function(forest_object, quantiles, train_matrix, outcome_index, num_threads) {
    .Call('_grf_quantile_predict_oob', PACKAGE = 'tsgrf', forest_object, quantiles, train_matrix, outcome_index, num_threads)
}

regression_train <- function(train_matrix, outcome_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, nonlapping_block_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed, honesty_method) {
    .Call('_grf_regression_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, nonlapping_block_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed, honesty_method)
}

regression_predict <- function(forest_object, train_matrix, outcome_index, test_matrix, num_threads, estimate_variance) {
    .Call('_grf_regression_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, test_matrix, num_threads, estimate_variance)
}

regression_predict_oob <- function(forest_object, train_matrix, outcome_index, num_threads, estimate_variance) {
    .Call('_grf_regression_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, num_threads, estimate_variance)
}
...
ll_regression_train <- function(train_matrix, outcome_index, ll_split_lambda, ll_split_weight_penalty, ll_split_variables, ll_split_cutoff, overall_beta, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, num_threads, seed) {
    .Call('_grf_ll_regression_train', PACKAGE = 'tsgrf', train_matrix, outcome_index, ll_split_lambda, ll_split_weight_penalty, ll_split_variables, ll_split_cutoff, overall_beta, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, num_threads, seed)
}
...
ll_regression_predict <- function(forest_object, train_matrix, outcome_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance) {
    .Call('_grf_ll_regression_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
}
...
ll_regression_predict_oob <- function(forest_object, train_matrix, outcome_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance) {
    .Call('_grf_ll_regression_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
}
...
survival_predict <- function(forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, test_matrix, num_threads, num_failures) {
    .Call('_grf_survival_predict', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, test_matrix, num_threads, num_failures)
}
...
survival_predict_oob <- function(forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, num_threads, num_failures) {
    .Call('_grf_survival_predict_oob', PACKAGE = 'tsgrf', forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, num_threads, num_failures)
}
